...
<body>
    ...
    <!-- Add Member FORM -->
    <div class="card1">
        <form class="addMemberForm" action="process.php" method="post" id="addmember">
            <div class="mb-3">
            ...
            <a href="addmember.php"> <button type="submit" class="btn btn-primary addmemberButton">ADD MEMBER</button></a>
        </form>
    </div>
