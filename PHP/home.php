  ...
  <div class="buttonContainer">
    <div class="button-wrapper">
      ...
      <div class="membersButton button__group-item">
        <a href="findmember.php"><button type="submit" class="btn btn-primary function">MEMBERS</button></a>
        <p>Search, Add, and Remove members from the database</p>
      </div>

      <!-- CHECKOUT -->
      <div class="checkoutButton button__group-item">
        <a href="checkout.php"><button type="submit" class="btn btn-primary function">CHECK OUT</button></a>
        <p>Add item to cart and submit sales record into database</p>
      </div>

      <!-- SALES -->
      <div class="salesButton button__group-item">
        <a href="sales.php"><button type="submit" class="btn btn-primary function">SALES</button></a>
